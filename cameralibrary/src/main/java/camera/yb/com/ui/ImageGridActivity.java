...
import camera.yb.com.DataHolder;
import camera.yb.com.ImageDataSource;
import camera.yb.com.ImagePicker;
import camera.yb.com.R;
import camera.yb.com.adapter.ImageFolderAdapter;
import camera.yb.com.adapter.ImageRecyclerAdapter;
import camera.yb.com.adapter.ImageRecyclerAdapter.OnImageItemClickListener;
import camera.yb.com.bean.ImageFolder;
import camera.yb.com.bean.ImageItem;
import camera.yb.com.util.Utils;
import camera.yb.com.view.FolderPopUpWindow;
import camera.yb.com.view.GridSpacingItemDecoration;
...
/**
 * ================================================
 * 作    者：yangbo（yangbo Github地址：https://github.com/yb801925
 * 版    本：1.0
 * 创建日期：2016/5/19
 * 描    述：
 * 修订历史：
